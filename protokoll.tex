...
Das folgende Bild zeigt die ausgeführten Befehle in der Kommandozeile.
  \begin{figure}[h!]
    \centering
    \fbox{
      \includegraphics[width=0.8\textwidth]{imgs/stage_solution.png}
    }
...
Das folgende Bild zeigt die ausgeführten Befehle in der Kommandozeile.
  \begin{figure}[h!]
    \centering
    \fbox{
      \includegraphics[width=0.8\textwidth]{imgs/stagee_solution.png}
    }
...
Das folgende Bild zeigt die ausgeführten Befehle in der Kommandozeile.
  \begin{figure}[h!]
    \centering
    \fbox{
      \includegraphics[width=0.8\textwidth]{imgs/stageee_solution.png}
    }
...
Das folgende Bild zeigt die ausgeführten Befehle in der Kommandozeile.
  \begin{figure}[h!]
    \centering
    \fbox{
      \includegraphics[width=0.8\textwidth]{imgs/stageeee_solution.png}
    }
...
\end{itemize}
  ...
  \begin{figure}[h!]
    \centering
    \fbox{
      \includegraphics[width=0.8\textwidth]{imgs/stageeeee_base64_output.png}
    }
  ...
  \begin{figure}[h!]
    \centering
    \fbox{
      \includegraphics[width=0.8\textwidth]{imgs/stageeeee_solution.png}
    }
