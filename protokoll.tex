...
\begin{document}
	...
	Um diese Aufgabe zu l\"osen, hat es gen\"ugt, das besagte PDF im Browser zu \"offnen (Dazu Port-Forwarding öffnen mittels \lstinline{ssh -L 9000:10.10.10.201:80 lab} und anschließend im Browser die Adresse \lstinline{localhost:9000/team44/invoice.pdf} aufrufen).
